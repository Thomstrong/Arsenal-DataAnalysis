export default {
  ...
  'menu.studentInfo.center': '基本信息',
  'menu.studentInfo.settings': '个人设置',
  ...
  'menu.courseAnalysis':'科目信息',
  'menu.courseAnalysis.elective':'选课情况',
  'menu.courseAnalysis.subject':'课程分数',
  'menu.courseAnalysis.collageExam':'高考直通车',
  'menu.class':'班级信息',
  'menu.class.analysis':'班级分析',

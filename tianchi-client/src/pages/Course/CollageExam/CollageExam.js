            ...
            <Paragraph style={{ marginLeft: 30 }}>
              <ul>
                ...
                <li style={{ marginBottom: 10 }}>
                  ...
                  多是药学、<Text type='danger'>医学</Text>、环境工程、生物技术、土木类等；
                </li>
                <li style={{ marginBottom: 10 }}>
                  选修<Text type='danger'>历史</Text>即可填报的专业多是
                  <Text type='danger'>文学类</Text>、教育类、语言类、历史学和国际贸易等；
                </li>
                <li style={{ marginBottom: 10 }}>
                  选修<Text type='danger'>地理</Text>即可填报的专业除了语言等文学类专业外还集中在

          ...
          <Row style={{ padding: 10 }} type="flex" align="middle">
            ...
            <Col offset={1} xl={5} xs={23}>
              <Card bordered={false} hoverable={true}>
                <Paragraph><Text type="danger">{this.state.term}-{this.state.term+1}</Text>学年<Text type="danger">高{this.state.grade}</Text>
          ...
          <Row style={{ padding: 10 }} type="flex" align="middle">
            <Col xl={5} xs={24}>
              <Card bordered={false} hoverable={true}>
                <Paragraph><Text type="danger">{this.state.term}-{this.state.term+1}</Text>学年<Text type="danger">高{this.state.grade}</Text>
                  <Text type="danger">{COURSE_FULLNAME_ALIAS[this.state.course]}</Text>:</Paragraph>
                <Paragraph> 平均分最<Text type="danger">高</Text>出现在<Text type="danger">{averageHighExam}</Text>的<Text type="danger">{averageHighClass}班</Text>,
                    为<Text type="danger">{averageHighScore}</Text>分;</Paragraph>
                <Paragraph> 平均分最<Text type="danger">低</Text>出现在<Text type="danger">{averageLowExam}</Text>的<Text type="danger">{averageLowClass}班</Text>,

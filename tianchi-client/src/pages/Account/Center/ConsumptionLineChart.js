...
const ConsumptionLineChart = memo(
  ({ timelyConsumptionData,dailyConsumptionData }) => (
      <React.Fragment>
          <div>
            {/*两个有标题的card用来表示某时刻消费和对比消费*/}
            <Card title="某时段的平均消费" bordered={false} style={{ width: '100%'}}>
                <Row>
                    <Col span={20}>
                        {/*todo 可以加上datamarker*/}
                        <Chart
                          ...
                          />
                          <Geom type="line" position="time*cost" size={2} />
                          <Geom
                            type="point"
                            position="time*cost"
                            size={4}
            ...
            <Card title="单天消费总额对比" bordered={false} style={{ width: '100%'}}>
                <Row>
                    ...
                    <Col span={20}>
                       <Chart height={400} data={dailyConsumptionData} scale={cols} forceFit>
                          <Legend />
                          <Axis name="time" />
                          <Axis
                            name="cost"
